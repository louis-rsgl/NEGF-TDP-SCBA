    ...
    return [
        {
            ...
            "type": "software",
            "authors": ["Louis Rossignol", "Zhanghao Zhouyin", "Hong Guo"],
            "title": (
                "NEGF TDP PS-SCBA: Protocol-Conditioned Projected "
...
def software_provenance(repository_root: Path | None = None) -> dict[str, Any]:
    ...
    revision = git_state(repository_root)
    return {
        "software": {
            "name": SOFTWARE_NAME,
            "repository": REPOSITORY_URL,
...
def system_provenance(system, repository_root: Path | None = None) -> dict[str, Any]:
    ...
    result["calculation"] = {
        ...
        "units": {
            ...
            "stored_time": "ps",
            "stored_current": "uA",
            "storage_convention": "natural_backend_physical_output_v1",
        },
        "settings": settings,
    }
